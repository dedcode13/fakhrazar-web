      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <form className="mt-14 grid sm:grid-cols-2 gap-6">
          <input
            ...
            className="bg-white/5 border border-white/10 rounded-md px-6 py-4 outline-none focus:border-lime-400 transition"
          />
          <input
            type="tel"
          ...
          <input
            type="email"
            placeholder="ایمیل"
            className="bg-white/5 border border-white/10 rounded-md px-6 py-4 outline-none focus:border-lime-400 transition sm:col-span-2"
          />
          <textarea
