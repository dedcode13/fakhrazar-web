      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.map(({ title, text, Icon }) => (
            <div
              key={title}
              className="group relative rounded-none bg-neutral-100 p-10 hover:-translate-y-3 hover:bg-neutral-900 hover:text-white transition-all duration-500"
            >
              <CornerFrame color="border-neutral-400 group-hover:border-lime-400" />
              <div className="h-20 w-20 rounded-none bg-neutral-900 group-hover:bg-lime-400 group-hover:text-black text-lime-400 flex items-center justify-center mb-8 transition-colors duration-500">
                <Icon />
              </div>
