      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.map(({ title, text, Icon }) => (
            <div
              key={title}
              className="group rounded-[40px] bg-neutral-100 p-10 hover:-translate-y-3 hover:bg-neutral-900 hover:text-white transition-all duration-500"
            >
              <div className="h-20 w-20 rounded-2xl bg-neutral-900 group-hover:bg-lime-400 group-hover:text-black text-lime-400 flex items-center justify-center mb-8 transition-colors duration-500">
                <Icon />
              </div>
