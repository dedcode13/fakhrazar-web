      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {steps.map((s) => (
            <div
              key={s.n}
              className="relative border border-white/10 rounded-none p-8 hover:border-orange-500/50 hover:bg-white/5 transition"
            >
              <div className="text-orange-500 font-black text-3xl mb-6">{s.n}</div>
