...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-end overflow-hidden bg-neutral-950">
      <Image
      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 pb-24 pt-40 text-white">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <button className="border border-white/30 px-8 py-4 rounded-full hover:bg-white/10 transition backdrop-blur-sm">
              مشاهده محصولات
            </button>
          </div>
        </motion.div>
